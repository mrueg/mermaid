  ...
  describe('buildShapeDoc', () => {
    it('should build shapesTable based on the shapeDefs', () => {
      expect(buildShapeDoc()).toMatchInlineSnapshot(`
        ...
        | Complicated Subsystem             | Octagon                | \`oct\`          | Complicated subsystem (Team Topologies)                                                    | \`complicated-subsystem\`, \`octagon\`, \`tt-complicated\`                        |
        | Data Input/Output                 | Lean Right             | \`lean-r\`       | Represents input or output                                                                 | \`in-out\`, \`lean-right\`                                                      |
        | Data Input/Output                 | Lean Left              | \`lean-l\`       | Represents output or input                                                                 | \`collaboration\`, \`lean-left\`, \`out-in\`, \`tt-collab\`                         |
        ...
        | Event                             | Rounded Rectangle      | \`rounded\`      | Represents an event                                                                        | \`enabling-team\`, \`event\`, \`stream-aligned-team\`, \`tt-enabling\`, \`tt-stream\` |
        ...
        | Process                           | Rectangle              | \`rect\`         | Standard process shape                                                                     | \`platform-team\`, \`proc\`, \`process\`, \`rectangle\`, \`tt-platform\`              |
        | Start                             | Circle                 | \`circle\`       | Starting point                                                                             | \`circ\`, \`facilitation\`, \`tt-facilitation\`                                   |
        ...
        | X-as-a-Service                    | Triangle Right         | \`tri-right\`    | Right-pointing triangle — service provider on the base (left), consumer at the tip (right) | \`tt-xaas\`, \`x-as-a-service\`                                                 |
        "
      `);
    });
  });
